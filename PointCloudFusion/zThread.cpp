#include "zThread.h"
#include <QDebug>
zThread::zThread(pcl::PointCloud<pcl::PointXYZ>::Ptr p_cloud,std::string p_Path,zThread::IOType p_type ,QThread *parent)
...
void zThread::run()
{
    if(type == zThread::READ){
        ...
        pcl::io::savePCDFileASCII<pcl::PointXYZ> (pcd_Path, *cloud); //将点云保存到PCD文件中
